...
static const uint8_t font8x8[128][8] = {
    ...
    ['b'] = {0x06,0x06,0x3C,0x66,0x66,0x66,0x3C,0x00},
    ['c'] = {0x00,0x00,0x3C,0x66,0x06,0x66,0x3C,0x00},
    ['d'] = {0x60,0x60,0x3C,0x66,0x66,0x66,0x3C,0x00},
    ['e'] = {0x00,0x00,0x3C,0x66,0x7E,0x06,0x3C,0x00},
    ['f'] = {0x1C,0x36,0x06,0x0F,0x06,0x06,0x06,0x00},
    ['g'] = {0x00,0x00,0x3E,0x66,0x66,0x3E,0x60,0x3C},
    ['h'] = {0x06,0x06,0x3C,0x66,0x66,0x66,0x66,0x00},
    ['i'] = {0x18,0x00,0x1C,0x18,0x18,0x18,0x3C,0x00},
    ['j'] = {0x30,0x00,0x38,0x30,0x30,0x30,0x30,0x1C},
    ['k'] = {0x06,0x06,0x66,0x6C,0x78,0x6C,0x66,0x00},
    ['l'] = {0x1C,0x18,0x18,0x18,0x18,0x18,0x3C,0x00},
    ['m'] = {0x00,0x00,0x6C,0x7E,0x7E,0x6B,0x63,0x00},
    ['n'] = {0x00,0x00,0x3C,0x66,0x66,0x66,0x66,0x00},
    ['o'] = {0x00,0x00,0x3C,0x66,0x66,0x66,0x3C,0x00},
    ['p'] = {0x00,0x00,0x3C,0x66,0x66,0x3C,0x06,0x06},
    ['q'] = {0x00,0x00,0x3C,0x66,0x66,0x3C,0x60,0x60},
    ['r'] = {0x00,0x00,0x36,0x1C,0x18,0x18,0x18,0x00},
    ['s'] = {0x00,0x00,0x3E,0x60,0x3C,0x06,0x7C,0x00},
    ['t'] = {0x08,0x18,0x3E,0x18,0x18,0x18,0x1C,0x00},
    ['u'] = {0x00,0x00,0x66,0x66,0x66,0x66,0x3E,0x00},
    ['v'] = {0x00,0x00,0x66,0x66,0x66,0x3C,0x18,0x00},
    ['w'] = {0x00,0x00,0x63,0x6B,0x7F,0x36,0x36,0x00},
    ['x'] = {0x00,0x00,0x66,0x3C,0x18,0x3C,0x66,0x00},
    ['y'] = {0x00,0x00,0x66,0x66,0x66,0x3E,0x60,0x3C},
